...
class PAN_PP_V3(nn.Module):
    def __init__(self, backbone, neck, detection_head, recognition_head=None):
        ...
        self.conv1x1 = Conv_BN_ReLU(128*3, 128*4)

        self.attn_top = attn(128)
        self.attn_mid = attn(128)
        self.attn_bot = attn(128)
    ...
    def forward(self,
        ...
        f1 = self.attn_top(F1, F2, F3)
        f2 = self.attn_bot(M1, M2, M3)
        f3 = self.attn_mid(F2, F3, F4)
