...
ic15_root_dir = '/root/Storage/datasets/TBrain_2/'

ic15_train_data_dir = ic15_root_dir + 'train/train_images/'
ic15_train_gt_dir = ic15_root_dir + 'train/train_gts/'

ic15_test_data_dir = ic15_root_dir + 'train/test_images/'
ic15_test_gt_dir = ic15_root_dir + 'train/test_gts/'
...
class PAN_PP_TBRAIN(data.Dataset):
    def __init__(self,
                 split='train',
                 is_transform=False,
                 img_size=None,
